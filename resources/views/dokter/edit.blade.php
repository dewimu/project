                                ...
                                <form action="/dokter/{{$dokter->id}}/update" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                                            <option value="Laki-Laki" @if($dokter->jenis_kelamin == "Laki-Laki")
                                                selected @endif>Lali-Laki</option>
                                            <option value="Perempuan" @if($dokter->jenis_kelamin == "Perempuan")
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="spesialis" id="spesialis" class="form-control">
                                            <option value="Anak" @if($dokter->spesialis == "Anak") selected @endif>Anak
                                            </option>
                                            <option value="Mata" @if($dokter->spesialis == "Mata") selected @endif>Mata
                                            </option>
                                            <option value="THT" @if($dokter->spesialis == "THT") selected @endif>THT
                                            </option>
                                            <option value="Umum" @if($dokter->spesialis == "Umum") selected @endif>Umum
                                            </option>
                                            <option value="Gigi" @if($dokter->spesialis == "Gigi") selected @endif>Gigi
                                            </option>
                                            <option value="Dalam" @if($dokter->spesialis == "Dalam") selected
                                                @endif>Dalam</option>
                                        </select>
                                    </div>
    ...
    <div class="col-lg-12">
        <form action="/dokter/{{$dokter->id}}/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="jenis_kelamin">Jenis Kelamin</label>
                <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                    <option value="Laki-Laki" @if($dokter->jenis_kelamin == "Laki-Laki") selected @endif>Lali-Laki
                    </option>
                    <option value="Perempuan" @if($dokter->jenis_kelamin == "Perempuan") selected @endif>Perempuan
                    </option>
                </select>
            </div>
            <div class="form-group">
